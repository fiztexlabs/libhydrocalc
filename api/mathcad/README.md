...
**Аргументы**
  ...
  - **G**: Вектор геометрических характеристик гидравлического сопротивления. Его размер и значение элементов зависят от конкретного типа гидравлического сопротивления.
...
**Аргументы**
  - **Re**: Число Рейнольдса. Положительное значение числа рейнольдса соответсвтует прямому направлению потока через элемент, отрицательное - обратному. При этом некоторые элементы имеют различное сопротивление для прямого и обратного направлений. Например, при отрицательном числе Рейнольдса для диффузора, его гидравлическое сопротивление будет рассчитываться по диаграммам для конфузора.
  - **G**: Вектор геометрических характеристик композитного сопротивления:
    - G[0] - Эквивалентный гидравлический диаметр, к которому приводится суммарное гидравлическое сопротивление композитного элемента
    - G[1] - Эквивалентная длина композитного элемента. Определяет инерционность потока в элементе. В данный момент не используется.
  - **name**: Имя гидравлического сопротивления
...
Удаляет гидравлический элемент из памяти
 ...
 Возвращает массив геометрических характеристик элемента
 - **element_id**: Id элемента
 ...
 Возвращает число Рейнольдса в элементе. ПОложительные значения числа рейнольдса соотвтетствую прямому направлению потока в элементе, в то время как отрицательные - обратному.
 - **element_id**: Id элемента
