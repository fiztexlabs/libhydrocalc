...
LRESULT setRou_impl(
	...
	const COMPLEXSCALAR* const _rou)
{
	...
	try
	{
		hydrocalc::mathcad::hr_vec.at(static_cast<size_t>(_id->real)).get()->setRou(static_cast<hydrocalc::real>(_rou->real));
	}
...
FUNCTIONINFO fi_setRou =
{
	"hr_setRou",
	"",
	"",
	(LPCFUNCTION)setRou_impl,
	COMPLEX_SCALAR,
	2,
