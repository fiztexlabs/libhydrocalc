...
LRESULT getGeometryPartCoeff_impl(
	...
	const COMPLEXSCALAR* const _id)
{
	...
	try
	{
		_result->real = hydrocalc::mathcad::hr_vec.at(static_cast<size_t>(_id->real)).get()->getGeometryPartCoeff();
	}
...
FUNCTIONINFO fi_getGeometryPartCoeff =
{
	"hr_getGeometryPartCoeff",
	"",
	"",
	(LPCFUNCTION)getGeometryPartCoeff_impl,
	COMPLEX_SCALAR,
	1,
	{COMPLEX_SCALAR}
};