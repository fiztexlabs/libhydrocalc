	...
	const COMPLEXSCALAR* const _id)
{
	...
	try
	{
		_result->real = hydrocalc::mathcad::hr_vec.at(static_cast<size_t>(_id->real)).get()->getViscosity();
	}
...
FUNCTIONINFO fi_getViscosity =
{
	"hr_getViscosity",
	"",
	"",
	(LPCFUNCTION)getViscosity_impl,
	COMPLEX_SCALAR,
	1,
	{COMPLEX_SCALAR}
};