	...
	const COMPLEXSCALAR* const _id)
{
	...
	try
	{
		_result->real = hydrocalc::mathcad::hr_vec.at(static_cast<size_t>(_id->real)).get()->getLength();
	}
...
FUNCTIONINFO fi_getLength =
{
	"hr_getLength",
	"",
	"",
	(LPCFUNCTION)getLength_impl,
	COMPLEX_SCALAR,
	1,
	{COMPLEX_SCALAR}
};