...
LRESULT getLocalResistanceCoeff_impl(
	...
	const COMPLEXSCALAR* const _id)
{
	...
	try
	{
		_result->real = hydrocalc::mathcad::hr_vec.at(static_cast<size_t>(_id->real)).get()->getLocalResistanceCoeff();
	}
...
FUNCTIONINFO fi_getLocalResistanceCoeff =
{
	"hr_getLocalResistanceCoeff",
	"",
	"",
	(LPCFUNCTION)getLocalResistanceCoeff_impl,
	COMPLEX_SCALAR,
	1,
	{COMPLEX_SCALAR}
};