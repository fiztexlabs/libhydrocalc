...
LRESULT getRelFrictionCoeff_impl(
	...
	const COMPLEXSCALAR* const _id)
{
	...
	try
	{
		_result->real = hydrocalc::mathcad::hr_vec.at(static_cast<size_t>(_id->real)).get()->getRelFrictionCoeff();
	}
...
FUNCTIONINFO fi_getRelFrictionCoeff =
{
	"hr_getRelFrictionCoeff",
	"",
	"",
	(LPCFUNCTION)getRelFrictionCoeff_impl,
	COMPLEX_SCALAR,
	1,
	{COMPLEX_SCALAR}
};