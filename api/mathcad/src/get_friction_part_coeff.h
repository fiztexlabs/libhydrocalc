...
LRESULT getFrictionPartCoeff_impl(
	...
	const COMPLEXSCALAR* const _id)
{
	...
	try
	{
		_result->real = hydrocalc::mathcad::hr_vec.at(static_cast<size_t>(_id->real)).get()->getFrictionPartCoeff();
	}
...
FUNCTIONINFO fi_getFrictionPartCoeff =
{
	"hr_getFrictionPartCoeff",
	"",
	"",
	(LPCFUNCTION)getFrictionPartCoeff_impl,
	COMPLEX_SCALAR,
	1,
	{COMPLEX_SCALAR}
};